...
| server run 6 | + optimizer-step fix (chunk 10k × 300 epochs ≈ 3,900-4,200 Adam steps vs run 5's ~360), resumed from run-5 L1 net | **L2 PASSED** (100% win / 2.35 vs 2.34 — tie; probe-confirmed DAgger gain 93%/2.20→100%/2.33). L3 attempt-1 blocked: 100% win but 5.72 pieces vs beam 4.76 (a 20% efficiency gap — the compounding-error signature). Attempt 2 at time of writing |
